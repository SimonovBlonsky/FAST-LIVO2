...
POINT_CLOUD_REGISTER_POINT_STRUCT(Pandar40P_ros::Point,
                                  (float, x, x)(float, y, y)(float, z, z)(float, intensity, intensity)(float, t, t)(std::uint16_t, ring, ring))
/*****************/
// namespace Pandar40P_ros
// {
// struct EIGEN_ALIGN16 Point
...
// };
// } // namespace ouster_ros
// POINT_CLOUD_REGISTER_POINT_STRUCT(Pandar40P_ros::Point, (float, x, x)(float, y, y)(float, z, z)(float, intensity, intensity)
//                                   (std::uint32_t, t, t)(std::uint16_t, reflectivity,
//                                                         reflectivity)(std::uint8_t, ring, ring)(std::uint16_t, ambient, ambient)(std::uint32_t, range, range))
...
private:
  ...
  void Pandar40P_handler(const sensor_msgs::PointCloud2::ConstPtr &msg);
